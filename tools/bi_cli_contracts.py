...
COMMAND_DOMAINS: dict[str, str] = {
    ...
    "semantic-release-preview": "semantic",
    "semantic-release-publish": "semantic",
    "semantic-release-rollback": "semantic",
    "semantic-releases": "semantic",
    ...
    "workflow-recipe-preview": "workflow",
    "workflow-recipe-publish": "workflow",
    "workflow-recipes": "workflow",
    "workflow-recipe-plan": "workflow",
    ...
    "workspace-recovery-compare": "workspace-recovery",
    ...
    "list-metrics": "metric",
    "add-metric": "metric",
    "metric-contract-preview": "metric",
    "metric-contract-publish": "metric",
    "metric-contracts": "metric",
    "metric-contract-replay": "metric",
