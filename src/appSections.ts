...
export const appSections: Record<AppSection, AppSectionMeta> = {
  home: {
    ...
    headline: {
      zh: "下一步清晰，结果始终可追溯",
      en: "A clear next step with traceable results.",
    },
  ...
  sources: {
    ...
    headline: {
      zh: "接入、检查并准备真实数据",
      en: "Connect, inspect, and prepare real data.",
    },
  ...
  dashboards: {
    ...
    headline: {
      zh: "查看并编辑可信分析结果",
      en: "Review and edit trusted analysis results.",
    },
  ...
  agent: {
    ...
    headline: {
      zh: "描述问题，获得可核对的回答",
      en: "Describe a question and get a reviewable answer.",
    },
  ...
  evidence: {
    ...
    headline: {
      zh: "核对来源、口径和执行回执",
      en: "Review sources, definitions, and run receipts.",
    },
  ...
  settings: {
    ...
    headline: {
      zh: "管理外观、权限和本地配置",
      en: "Manage appearance, permissions, and local configuration.",
    },
...
export const appSectionOrder: AppSection[] = ["home", "sources", "agent", "dashboards", "evidence", "views", "settings"];
