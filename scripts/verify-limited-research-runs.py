...
with tempfile.TemporaryDirectory(prefix="aibi-c-limited-research-") as temp_dir:
    ...
    check("schema-v18-initializes-research-ledger", initialized.get("ok") is True and imported.get("committed") is True and version == 18 and {"research_runs", "research_plan_revisions", "research_observations", "research_run_events"}.issubset(tables), {"version": version, "tables": sorted(tables)})
