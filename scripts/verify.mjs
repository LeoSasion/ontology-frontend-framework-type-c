...
const checks = [
  ...
  run("cli-enable-erp-domain-pack", "python", ["tools/bi_cli.py", "--json", "domain-pack-set", "--pack", "erp-units", "--state", "enabled", "--yes"]),
  ...
  run("cli-agent-formula-draft", "python", ["tools/bi_cli.py", "--json", "ask", "保存平均值公式 AVG([net_sales])"]),
