  ...
  checks.push(
      ...
      },
    {
        ...
        ok: byLabel["cli-workspace-delete-target-create"]?.parsed?.created?.id === "delete_workspace_target" &&
          ...
          byLabel["cli-workspace-delete-dry-run"]?.parsed?.deletePlan?.schema === "aibi-workspace-delete-plan/v1" &&
          ...
          byLabel["cli-workspace-delete-confirm"]?.parsed?.lifecycleStatus === "completed" &&
          byLabel["cli-workspace-delete-confirm"]?.parsed?.auditRecoveryPoint?.verified === true &&
