...
- 验证命令优先记录稳定入口：`npm run build`、`npm run verify`、`npm run verify:ui`、`npm run verify:ui-empty`、`npm run verify:ui-import`、`npm run verify:bi-cli-contract`、`npm run verify:erp-units`。
